...
layout: post
title: Tomcat
subtitle: 'tomcat是一个免费的，开放源代码的Web应用服务器'
date: 2019-02-26
author: 丶德灬锅
tags: Tomcat
---
...
![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-02-26-Tomcat下载.png)

### 2、设置环境变量

解压版单独启动Tomcat需要设置JAVA_HOME环境变量，在Intellij和Eclipse中启动Tocmat不需要。

![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-02-26-Tomcat设置环境变量.png)
...
- 启动警告The APR based Apache Tomcat Native library which allows optimal performance in production
  ...
  ![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-02-26-Tomcat常见问题1.png)

  

  ![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-02-26-Tomcat常见问题2.png)
