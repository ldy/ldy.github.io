...
layout: post
title: XML
subtitle: '可扩展标记语言（英语：Extensible Markup Language，简称：XML），是一种标记语言。'
date: 2018-12-18
author: 丶德灬锅
tags: XML
---
...
- 处理指令
  ...
  ![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2018-12-18-XML处理指令预览效果.png)
...
- DOM[^13]
  ...
  - DOM4J
    ...
    ![XML文档的DOM表示](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2018-12-18-XML文档的DOM表示.gif)
