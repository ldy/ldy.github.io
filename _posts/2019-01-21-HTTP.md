...
layout: post
title: HTTP
subtitle: '超文本传输协议（英语：HyperText Transfer Protocol，缩写：HTTP）是一种应用层协议，在Web应用中，服务器把网页传给浏览器，实际上就是把网页的HTML代码发送给浏览器，让浏览器显示出来，而浏览器和服务器之间的传输协议是HTTP。'
date: 2019-01-21
author: 丶德灬锅
...
![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-01-21-HTTP重定向.jpg)

## DNS寻址过程[^11]

![](https://cdn.jsdelivr.net/gh/ldy/jekyll@master/_posts/img/2019-01-21-HTTP寻址流程.jpg)
